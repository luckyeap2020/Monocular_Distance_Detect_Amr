            ...
            for i, det in enumerate(pred):  # detections per image
                ...
                if len(det):
                    ...
                    for *xyxy, conf, cls in reversed(det):
                        ...
                        if ((kuang[1] * self.W) - (self.W/2)) > 20:  #判断目标在图像的左侧 -1 还是右侧 1，居中 0
                            location = 1
                        ...
                        if save_csv:
                            storage.append([txt_path, frame, names[int(cls)], (kuang[1] * self.W), kuang[2]*self.H+kuang[4]*self.H/2, distance, d[0], d[1], (kuang[3]*self.W), (kuang[4]*self.H)])
