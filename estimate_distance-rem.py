...
class DistanceEstimation:
    ...
    def distance(self, kuang, xw=5, yw=0.1):
       ...
       # print('距离', d1)
        ...
        print('距离',distance, d1[0],d1[1])
        return distance, d1


    def Detect(self, weights='weights/yolov5s.pt',
        ...
        IMG_FORMATS = ['bmp', 'dng', 'jpeg', 'jpg', 'mpo', 'png', 'tif', 'tiff', 'webp',
                       'pfm']  # include image suffixes
        VID_FORMATS = ['asf', 'avi', 'gif', 'm4v', 'mkv', 'mov', 'mp4', 'mpeg', 'mpg', 'ts',
                       'wmv']  # include video suffixes
                    ...
                    for *xyxy, conf, cls in reversed(det):
                        ...
                        if save_img or save_crop or view_img:  # Add bbox to image
                            ...
                            if label != None and distance!=0:
                                label = label + ' '  + str('%.1f' % distance) + 'm('+ str('%.1f' % d[0]) + ',' + str('%.1f' % d[1]) + ')'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='inference/images', help='file/dir/URL/glob, 0 for webcam')
